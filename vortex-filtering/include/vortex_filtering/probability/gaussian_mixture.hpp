...
public:
	...
	GaussianMixture(std::vector<double> weights, std::vector<Gauss_n> gaussians) : weights_(Eigen::Map<Eigen::VectorXd>(weights.data(), weights.size())), gaussians_(std::move(gaussians)) {}
...
template <int n_dims>
GaussianMixture<n_dims> operator+(const GaussianMixture<n_dims> &lhs, const GaussianMixture<n_dims> &rhs)
{
...
template <int n_dims>
GaussianMixture<n_dims> operator*(double weight, const GaussianMixture<n_dims> &rhs)
{
...
template <int n_dims>
GaussianMixture<n_dims> operator*(const GaussianMixture<n_dims> &lhs, double weight)
{
	return weight * lhs;
}

template <int n_dims>
GaussianMixture<n_dims> operator*(double weight, const MultiVarGauss<n_dims> &rhs)
{
	return weight * GaussianMixture<n_dims>({1}, {rhs});
}

template <int n_dims>
GaussianMixture<n_dims> operator*(const MultiVarGauss<n_dims> &lhs, double weight)
{
	return weight * lhs;
}
