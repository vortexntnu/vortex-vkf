...
public:
	...
	virtual std::pair<GaussX, GaussX> predictX(const DynModXPtr& dyn_mod, const SensModXPtr& sens_mod, double dt, const GaussX& x_est_prev, const VecX& u) const = 0;
	...
	virtual std::tuple<GaussX, GaussX, GaussX> stepX(const DynModXPtr& dyn_mod, const SensModXPtr& sens_mod, double dt, const GaussX& x_est_prev, const VecX& z_meas, const VecX& u) const = 0;
...
class KalmanFilter : public KalmanFilterX {
public:
	...
	virtual std::tuple<Gauss_x, Gauss_x, Gauss_z> step(DynModIPtr dyn_mod, SensModIPtr sens_mod, double dt, const Gauss_x& x_est_prev, const Vec_z& z_meas, const Vec_u& u) const = 0;
...
protected:
	...
	std::tuple<GaussX, GaussX, GaussX> stepX(const DynModXPtr& dyn_mod, const SensModXPtr& sens_mod, double dt, const GaussX& x_est_prev, const VecX& z_meas, const VecX& u) const override 
	{
		DynModIPtr dyn_mod_   = std::static_pointer_cast<DynModI>(dyn_mod);
		SensModIPtr sens_mod_ = std::static_pointer_cast<SensModI>(sens_mod);
		Gauss_x x_est_prev_   = x_est_prev;
