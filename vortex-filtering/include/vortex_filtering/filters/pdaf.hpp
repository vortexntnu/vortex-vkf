...
public:
  ...
  static std::tuple<Gauss_x, Gauss_x, Gauss_z, StatesXd, Arr_1Xb> step(const DynModT &dyn_model, const SensModT &sen_model, double timestep,
                                                                                const Gauss_x &x_est, const Arr_zXd &z_measurements, const Config &config)
  {
  ...
  static Gauss_x get_weighted_average(const Arr_zXd &z_measurements, const StatesXd &updated_states, const Gauss_z &z_pred, const Gauss_x &x_pred,
