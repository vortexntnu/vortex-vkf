...
public:
  IPDAFilter();
  double generate_new_probability(std::vector<Eigen::Vector2d> &measurements, double &probability_of_survival, float &probability_of_detection,
                                  double &standard_deviation, float &lambda);
...
IPDAFilter::IPDAFilter() { last_detection_probability_ = 0.0; }
...
double IPDAFilter::generate_new_probability(std::vector<Eigen::Vector2d> &measurements, double &probability_of_survival, float &probability_of_detection,
                                            double &standard_deviation, float &lambda)
{
...
double IPDAFilter::get_last_detection_probability() { return last_detection_probability_; }
