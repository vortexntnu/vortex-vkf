...
protected:
  ...
  IMMIPDA()
      ...
      , config_{.pdaf =
                ...
                .immipda = {
                    .states_min_max = {{S::position, {-100.0, 100.0}}, {S::velocity, {-10.0, 10.0}}},
                }} {};
...
TEST_F(IMMIPDA, step)
{
  ...
  Eigen::Matrix4d mode_2_cov = prob::Uniform<4>{{-1.0, -1.0, min_vel, min_vel}, {1.0, 1.0, max_vel, max_vel}}.cov();

  ImmModel_::GaussTuple_x x0     = {prob::Gauss2d::Standard(), {{0.0, 0.0, 1.0, 0.0}, mode_2_cov}};
